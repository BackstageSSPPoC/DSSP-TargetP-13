...
pipeline {
    ...
    environment {
        APP_NAME = "DSSP-TargetP-13".toLowerCase().trim()
        DOCKER_IMAGE = "chaitanyapandeygspann/DSSP-TargetP-13/dssp-targetp-13"
...
// ================= CI STAGES =================
        ...
        stage('Setup Environment') {
            steps {
                sh """
                python3 -m venv venv && . venv/bin/activate && pip3 install --upgrade pip && pip3 install -r requirements.txt
                """
            }
        }
